...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> syncReceipt() async {
    if (isDebug) { setState(() => _debugText = 'syncReceipt'); }
...
*/
    ...
    request.fields['shop_branch_ID'] = widget.config.shop_branch_ID.toString();
    ...
    request.fields['FoodOrderItemList'] = jsonEncode(
      pushData['FoodOrderItemList'],
    );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (data['encodedImage'] != null && data['encodedImage']['imageBase64Encoded'] != null) {
          setState(() {
            _ppQrBase64 = data['encodedImage']['imageBase64Encoded'];
          });
        } else {
